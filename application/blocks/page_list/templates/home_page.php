...
<div class="ccm-block-page-list-wrapper home-page-list">
    ...
    //$date = $dh->formatDateTime($page->getCollectionDatePublic(), true);
        $date = date('d F Y', strtotime($page->getCollectionDatePublic()));
    ...
    ?>
                        <h2 class="title"><a href="<?php echo $url ?>" target="<?php echo $target ?>"><?php echo $title ?></a></h2>
                    <?php
}
    ?>
                </div>
    ...
    ?>
                ...
                <?php if (isset($includeDate) && $includeDate): ?>
                    <div class="ccm-block-page-list-date"><strong>Posted on: </strong><?php echo $date?></div>
                <?php endif;
    ?>
    ...
    ?>
                ...
                <br/><?php echo NavHelper::getTags($page); ?>
