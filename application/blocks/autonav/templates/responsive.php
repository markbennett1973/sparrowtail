...
if (count($navItems) > 0) {
    echo '<div id="main-menu">'; // opens the full-size nav div
    ...
    echo '</div>'; // close the full-size nav div

    // Print out the responsive nav
    echo '<div class="selector">';
    echo '<span>Menu</span>';
    echo '<select style="opacity: 0">';
    echo '<option value="">-- Select --</option>';
    foreach ($navItems as $ni) {
        echo '<option value="' . $ni->url . '">' . $ni->name . '</option>';
    }
    echo '</select></div>';
