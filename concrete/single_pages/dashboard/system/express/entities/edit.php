    ...
    <div class="col-md-8">
        ...
        <form method="post" action="<?php echo $view->action('update', $entity->getID())?>">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="name" class="control-label"><?php echo t('Custom Dispay Order') ?></label>
...
<div style="display: none">
    <div id="ccm-dialog-delete-entity" class="ccm-ui">
        <form method="post" action="<?php echo $view->action('delete')?>">
            ...
            <p><?php echo t('Are you sure you want to delete this entity? All data entries for it will be removed. This cannot be undone.')?></p>
